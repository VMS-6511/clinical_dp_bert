...
flags.DEFINE_enum("classification_task_name", "MNLI",
                  ["COLA", "MNLI", "MRPC", "QNLI", "SST-2", "XNLI", "MIMIC_MORT", "MIMIC_LOS", "MIMIC_READM"],
...
def generate_classifier_dataset():
  ...
  if FLAGS.tfds_params:
    ...
    processors = {
        ...
        "mimic_mort":classifier_data_lib.MIMICProcessor,
        "mimic_los": classifier_data_lib.MIMICProcessor,
        "mimic_readm": classifier_data_lib.MIMICProcessor
    }
